...
echo; echo "=== 9. 샘플러 + 가드 ==="
ssh $C "nohup /tmp/rt_sample.sh 'multi-fec-dist -c -l 127.0.0.1:519' /tmp/wg_c.csv $((SECS+600)) >/dev/null 2>&1 &" 2>/dev/null
ssh $R "nohup /tmp/rt_sample.sh 'multi-fec-dist -r -l 192.168.100.8[56]:$RPORT' /tmp/wg_r.csv $((SECS+600)) >/dev/null 2>&1 &" 2>/dev/null
ssh $S "nohup /tmp/rt_sample.sh 'multi-fec-dist -s -l $SRV:45' /tmp/wg_s.csv $((SECS+600)) >/dev/null 2>&1 &" 2>/dev/null
...
ssh $C "nohup /tmp/rt_sample.sh 'mf_blast' /tmp/wg_blast.csv $((SECS+600)) mf_blast >/dev/null 2>&1 &" 2>/dev/null
